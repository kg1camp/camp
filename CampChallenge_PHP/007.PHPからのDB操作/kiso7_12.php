...
<html>
  ...
  <section class="form_area">
    <p>プルダウンメニューから情報を上書きしたいuserIDを選択して、上書きしたい情報を入力してください。</p>
    <form action="kiso7_11_2.php" method="post">
      <ul>
        ...
        <li><label>電話番号：<input type="text" name="tell" required></label></li>
        <li><label>年齢：<input type="number" name="age" min="1" required></label></li>
        <li>誕生日：
